...
# Routed links:
# Core-FRR-1 <-> Dist-FRR-1  : 10.0.11.0/30
# Core-FRR-1 <-> Dist-FRR-2  : 10.0.21.0/30
# Core-FRR-1 <-> EdgeRouter  : 10.0.100.0/30
...
ip addr add 10.0.21.1/30 dev eth1
ip addr add 10.0.100.1/30 dev eth2

# Assign loopback management IP
ip addr add 10.255.0.11/32 dev lo 2>/dev/null || true
