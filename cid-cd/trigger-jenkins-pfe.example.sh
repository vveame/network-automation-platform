...
echo "[INFO] EXPERIMENT_CONTINUE_AFTER_VALIDATION_FAILURE=$EXPERIMENT_CONTINUE_AFTER_VALIDATION_FAILURE"
...
curl "${curl_args[@]}" \
  ...
  --data-urlencode "EXPERIMENT_CONTINUE_AFTER_VALIDATION_FAILURE=$EXPERIMENT_CONTINUE_AFTER_VALIDATION_FAILURE" \
