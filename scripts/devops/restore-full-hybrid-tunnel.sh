...
echo
echo "=================================================="
echo "2. Route DevOps AWS VPC traffic through EdgeRouter"
echo "=================================================="
...
echo
echo "=================================================="
echo "3. Ensure EdgeRouter WireGuard is up"
echo "=================================================="
...
echo
echo "=================================================="
echo "4. Reapply cloud monitoring access to OOB SNMP nodes"
echo "=================================================="
...
echo
echo "=================================================="
echo "5. Repair AWS monitoring EC2 internet egress NAT"
echo "=================================================="
...
echo
echo "=================================================="
echo "6. Validate EdgeRouter tunnel path"
echo "=================================================="
ssh root@"$EDGE_OOB_IP" "
...
echo
echo "=================================================="
echo "7. Validate DevOps route to AWS VPC"
echo "=================================================="
...
echo
echo "=================================================="
echo "8. Validate cloud Prometheus SNMP through tunnel"
echo "=================================================="
...
echo
echo "=================================================="
echo "9. Open Prometheus/Grafana UI tunnel in background"
echo "=================================================="
