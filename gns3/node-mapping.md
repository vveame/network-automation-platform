...
| Interface | Connected To | Mode | VLANs |
|---|---|---|---|
| eth0 | Dist-FRR-1 | Trunk | 10, 20, 99 |
| eth1 | Access-OVS-4 | Trunk | 10, 20, 99 |
| eth2 | Access-OVS-5 | Trunk | 10, 20, 99 |
| eth3 | Access-OVS-6 | Trunk | 10, 20, 99 |

### Dist-OVS-2

| Interface | Connected To | Mode | VLANs |
|---|---|---|---|
| eth0 | Dist-FRR-2 | Trunk | 10, 20, 99 |
| eth1 | Access-OVS-4 | Trunk | 10, 20, 99 |
| eth2 | Access-OVS-5 | Trunk | 10, 20, 99 |
| eth3 | Access-OVS-6 | Trunk | 10, 20, 99 |
...
| Interface | Connected To | IP / Network | Role |
|---|---|---|---|
| eth0 | EdgeRouter-VPNGateway | 10.0.100.1/30 | Routed OSPF link to edge |
| eth1 | Dist-FRR-1 | 10.0.11.1/30 | Routed OSPF link |
| eth2 | Dist-FRR-2 | 10.0.21.1/30 | Routed OSPF link |

### Core-FRR-2

| Interface | Connected To | IP / Network | Role |
|---|---|---|---|
| eth0 | EdgeRouter-VPNGateway | 10.0.101.1/30 | Routed OSPF link to edge |
| eth1 | Dist-FRR-1 | 10.0.12.1/30 | Routed OSPF link |
| eth2 | Dist-FRR-2 | 10.0.22.1/30 | Routed OSPF link |
...
| Interface | Connected To | IP / Network | Role |
|---|---|---|---|
| eth0 | DMZ-OVS | 172.16.50.1/24 | Gateway for DMZ |
| eth1 | Core-FRR-1 | 10.0.100.2/30 | Routed OSPF link |
| eth2 | Core-FRR-2 | 10.0.101.2/30 | Routed OSPF link |
| eth3 | External / Cloud / Internet | To be configured later | Future NAT/VPN/cloud link |
